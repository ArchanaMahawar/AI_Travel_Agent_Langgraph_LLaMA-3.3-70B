# AI_Travel_Agent_Langgraph_LLaMA-3.3-70B
...
pip install langgraph langchain langchain-community python-dotenv "psycopg[binary]" psycopg_pool

pip install langchain-openai langchain-groq langchain-tavily tavily-python requests
